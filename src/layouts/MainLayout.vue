<template>
  <q-layout view="hHh lpR fFf" class="bg-grey-1">
    <q-header elevated class="" height-hint="64">
            ...
            <q-menu>
              <div class="row no-wrap q-pa-md">
                <div class="column">
                  ...
                  <q-toggle v-model="darkMode" label="Modo oscuro" @input="switchDarkMode"/>
                </div>
                ...
                <div class="column items-center">
                  ...
                  <div class="text-subtitle1" style="font-size: 10px">William Condori</div>
                  <q-btn
                    color="primary"
                    label="Logout"
                    push
